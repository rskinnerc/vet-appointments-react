...
const Landing = () => {
  ...
  return (
    <section id="landing" className="h-screen bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500 flex flex-col">
      ...
      <Link to="vets" className="animate-bounce flex justify-between md:text-xl items-center bg-citrus-500 hover:shadow-md text-white p-2 w-4/6 sm:w-1/2 lg:w-1/3 self-center relative top-2/3 sm:top-60 md:top-2/3 lg:top-1/2 lg:bottom-12 md:py-4 shadow-lg text-center rounded-full font-semibold">
